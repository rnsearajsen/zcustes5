		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cust View",
									"targetURL": "#custes5zcustes5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"custes5zcustes5-display": {
								"semanticObject": "custes5zcustes5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=custes5.zcustes5",
									"url": sap.ui.require.toUrl("custes5/zcustes5")
								}
							}
						}
					}
